...
RPMPercent:0
	...
	componentDidMount: function () {
		...
		this.socket.on('ecuData', function (data) {
			...
			that.setState({ mph: data.mph.toFixed(2) })
			 that.setState({ 
intTemp: data.coolantTemp.toFixed(2),
airFlowVolt: data.airFlowVolt.toFixed(2),
wTemp:data.wTemp.toFixed(2),
throttleVolt: data.throttleVolt.toFixed(2),
batteryVolt:data.batteryVolt.toFixed(2) });
			that.setState({
...
<tr>
				...
				<td><div className="container" style={{borderRight: this.state.showRPM ?`2px solid white`:""}}>
					<div style={{width:`${this.state.RPMPercent}%`,height:"100%",background:`${this.state.rpm >7500 ?"red":"green"}`,borderRight: !this.state.showRPM ?`2px solid white`:""}}></div>
					</div></td>
...
<tr>
				...
				<td className="td"><div className="container" style={{borderRight: this.state.showTV ?`2px solid white`:""}}>
					<div style={{width:`${this.state.throttleVolt}%`,height:"100%",background:"green",borderRight: !this.state.showTV ?`2px solid white`:""}}></div>
					</div></td>
			...
			<tr>
				...
				<td><div className="container" style={{borderRight: this.state.showAFV ?`2px solid white`:""}}>
					<div style={{width:`${this.state.airFlowVoltPercent}%`,height:"100%",background:"green",borderRight: !this.state.showAFV ?`2px solid white`:""}}></div>
					</div></td>
...
<tr>
				...
				<td style={{textAlign:"center"}}><img src="1654014323912.jpg" width="30px" /></td>
				<td><div className="container" style={{borderRight: this.state.showAFV ?`2px solid white`:""}}>
					<div style={{width:`${this.state.batteryVoltPercent}%`,height:"100%",background:"green",borderRight: !this.state.showAFV ?`2px solid white`:""}}></div>
					</div></td>
...
<tr>
				...
				<td className="td"><div className="container" style={{borderRight: this.state.showTV ?`2px solid white`:""}}>
					<div style={{width:`${this.state.wTempPercent}%`,height:"100%",background:"green",borderRight: !this.state.showTV ?`2px solid white`:""}}></div>
					</div></td>
...
<td style={{textAlign:"center"}}><img src="1654014323912.jpg" width="30px" /></td>
				<td><div className="container" style={{borderRight: this.state.showAFV ?`2px solid white`:""}}>
					<div style={{width:`${this.state.intTempPercent}%`,height:"100%",background:"green",borderRight: !this.state.showAFV ?`2px solid white`:""}}></div>
					</div></td>
...
<tr>
				...
				<td><div className="container" style={{borderRight: "2px solid white"}}>
					<div style={{width:`${this.state.mphPercent}%`,height:"100%",background:"green",}}></div>
					</div></td>
