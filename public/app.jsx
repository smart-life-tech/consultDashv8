...
<tr>
				...
				<td className="td4">{this.state.batteryVolt.toFixed(1)} </td>
			</tr>
<tr>
				<td></td>
				<td style={{textAlign:"center"}}></td>
...
<tr style={{paddingTop:"220px !important"}}>
				<td></td>
				<td style={{textAlign:"center"}}></td>
				<td><div className="container" style={{borderRight: "2px solid white"}}>
					<div style={{width:`${this.state.mphPercent}%`,height:"100%",background:"#39FF14",}}></div>
					</div></td>
				<td className="td4" ><div>{parseInt(this.state.mphPercent)} </div></td>
			</tr>
