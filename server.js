...
if(wTemp < 120){
      ...
      socket.emit('ecuData', {'rpm':Math.floor(rpm),'mph':Math.floor(mph),'coolantTemp':Math.floor(coolantTemp) , 'airFlowVolt':airFlowVolt  , 'wTemp':Math.floor(wTemp), 'throttleVolt':Math.floor(throttleVolt), 'batteryVolt':batteryVolt});
    }, 100);
});